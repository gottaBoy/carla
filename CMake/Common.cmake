...
elseif (LINUX)
  set (EXE_EXT)
  # UE_SYSTEM_NAME is the target platform passed to UBT/UAT. The Build.sh
  # wrapper itself remains under the Linux host directory on ARM64.
  set (UE_HOST_SYSTEM_NAME Linux)
  if (CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64)$")
    set (UE_SYSTEM_NAME LinuxArm64)
  else ()
    set (UE_SYSTEM_NAME Linux)
  endif ()
elseif (APPLE)
  set (EXE_EXT)
  set (UE_HOST_SYSTEM_NAME Mac)
...
if (ENABLE_ALL_WARNINGS)
  if (CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
    # cl.exe accepts -Wall as a synonym for /Wall, which enables every
    # off-by-default diagnostic: it floods non-actionable warnings from system
    # headers and breaks third-party dependencies that compile with /WX
    # (googletest). Use /W4, the MSVC analog of -Wall -Wextra.
    check_cxx_compiler_flag(/W4 HAS_W4_MSVC)
    if (HAS_W4_MSVC)
